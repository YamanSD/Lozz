...
const ProductsBottom = ({ timescale,
  ...
  /* top-selling products data for the bar graph */
  ...
  useEffect(() => {
    let quantities = totalStats.sold_quantities;
    let keys = Object.keys(quantities);
    ...
    setTopSellingProducts({
      labels: tags,
      datasets: [{ data: tags.map(t => -quantities[t].actual) }]
    });
  }, [totalStats]);
