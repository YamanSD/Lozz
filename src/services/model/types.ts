...
export type product = {
  ...
  description?: string, // Common, Done
  [SpecialFields.trail]: TrailType
};
...
/**
 * - isTotal?: true iff the block is the total block.
 *
 ...
 *   Generated by restocks.
 *
 * - expenses: set containing expenses IDs in the block.
 *
 * - orders: set containing order IDs in the block.
 *
 * - restocks: set containing restocking IDs in the block.
 *
